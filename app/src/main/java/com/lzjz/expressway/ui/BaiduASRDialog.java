package com.lzjz.expressway.ui;
...
import com.lzjz.expressway.recognization.IRecogListener;
import com.lzjz.expressway.recognization.RecogResult;
...
public abstract class BaiduASRDialog extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkConfig();
        input = ((MyApplication) getApplicationContext()).getDigitalDialogInput();
